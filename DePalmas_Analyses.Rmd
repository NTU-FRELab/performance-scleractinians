...
Data and script for replicating analyses from De Palmas et al. 2024 (LINK).

If used in full or in part, please cite the original publication: Stéphane De Palmas, Qi Chen, Tsai-Hsuan Tony Hsu, Yunli Eric Hsieh, Pei-Ling Wang, Nicolas Sturaro, Vianney Denis (In preparation) Delineating scleractinian corals’ performance niches through insights from intraspecific variation.

The full dataset is also available on [Dryad](LINK). This is a study from [FRElab](https://www.dipintothereef.com/).
...
knitr::purl("DePalmas_Analyses.Rmd", documentation = F)
```

## **Importing the raw dataset**
```{r eval = T, echo = T, message = F, warning = F, results = "hide"}
#Import the raw data
data1 <- read.csv ("C:\\Users\\User\\OneDrive\\Bureau\\Strategies Coral Reef Revision\\DePalmas_dataset_strategy_data.csv", header = TRUE, sep=",", dec=".")
#Set the date format
...
### **Trait correlations**
```{r eval = T, echo = T, message = F, warning = F, results = "hide", fig.show='hide'}
# VIF check
...
write.csv(resdata.full)
resdata <- read.csv ("C:\\Users\\User\\OneDrive\\Bureau\\Strategies Coral Reef Revision\\resdata.full.csv", header = TRUE, sep=",", dec=".")
